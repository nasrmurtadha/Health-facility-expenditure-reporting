...
The project responds to challenges in fragmented and paper-based workflows, including repeated manual calculations, limited traceability, and difficulty consolidating information across facilities. It integrates facility records, financial transfers, expenditure planning, actual spending, validation checks, alerts, clearance reporting, and dashboards into one structured workflow.
I defined the workflow requirements, guided the AI-assisted development, reviewed formulas and outputs, corrected inconsistencies, and refined the workbook iteratively.
